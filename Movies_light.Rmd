...
Distribution of residuals looks left - skewed without outliers. It is not perfectly normal, but seems OK
...
There are a couple of other problems: influential points and collinearity. I've tried some options like robust regression and elastic net regularization. I would like to try some ensemble methods later.
